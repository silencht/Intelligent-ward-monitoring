...
//画横线画表
	...
	LCD_DrawLine(5, 77, 235, 77);//第三条线
	LCD_DrawLine(5, 99, 235, 99);//第四条线
	LCD_DrawLine(5, 153, 235, 153);//第五条线
	LCD_DrawLine(5, 213, 235, 213);//第六条线
	LCD_DrawLine(5, 272, 235, 272);//底二线
	LCD_DrawLine(5, 315, 235, 315);//底线

//画竖线
	LCD_DrawLine(235, 5, 235, 315);//右边线
	LCD_DrawLine(5, 5, 5, 315);//左边线
	LCD_DrawLine(77, 77, 77, 272);//左一竖线
	LCD_DrawLine(125, 77, 125, 272);//左2竖线
	
//写标题	
	LCD_ShowString(12,10,235,16,16,"Wireless monitoring system");
  POINT_COLOR=BLACK;
	LCD_ShowString(15,78,56,16,16," Item");
	LCD_ShowString(82,78,56,16,16,"Value");
	LCD_ShowString(160,78,56,16,16,"State");
  POINT_COLOR=DARKBLUE;
//显示病房参数
  LCD_ShowString(15,100,56,16,16," light");  // x82 y100	x126 y100
  LCD_ShowString(15,118,56,16,16," temp");   // x82 y118  x126 y118
  LCD_ShowString(15,136,56,16,16," humi"); 	 // x82 y136	x126 y136
//显示病人一参数	
  LCD_ShowString(15,154,56,16,16,"1 btemp"); // x82 y154  x126 y154
  LCD_ShowString(15,174,56,16,16,"1 hrate"); // x82 y174  x126 y174
  LCD_ShowString(15,194,56,16,16,"1 spo2");  // x82 y194  x126 y194
//显示病人二参数
  LCD_ShowString(15,214,56,16,16,"2 btemp"); // x82 y214  x126 y214
  LCD_ShowString(15,234,56,16,16,"2 hrate"); // x82 y234  x126 y234
  LCD_ShowString(15,254,56,16,16,"2 spo2");  // x82 y254  x126 y254
