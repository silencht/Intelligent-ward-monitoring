...
{  							  
	...
	{   
		...
		{			    
			...
			else if(mode==0)LCD_Fast_DrawPoint(x,y,WHITE);//BACK_COLOR  BLUE
			temp<<=1;
			y++;
...
//写标题	
  ...
  POINT_COLOR=DARKBLUE;
	LCD_ShowString(12,35,200,16,16,"Current patient number:");
	POINT_COLOR=BLUE;
	LCD_ShowString(12,60,200,16,16,"Initialization condition:");
	POINT_COLOR=DARKBLUE;
	LCD_DrawLine(5, 102, 235, 102);//第三条线
//画下面图标
 	LCD_Fill(109,242,131,311,RED); //红十字竖线
  LCD_Fill(85,266,155,287, RED); //红十字横线
	LCD_Fill(22,245,27,308,GREEN); //H左竖
	LCD_Fill(54,245,59,308,GREEN); //H右竖
	LCD_Fill(27,273,55,280,BRRED); //H横
	LCD_Fill(196,245,203,308,BRED); //T竖
	LCD_Fill(176,245,222,252,GRAYBLUE); //T横
//显示病人身体参数指示项
  LCD_ShowString(15,105,200,16,16,"light:");  
  LCD_ShowString(15,125,230,16,16,"temp:");
  LCD_ShowString(15,145,200,16,16,"humi:"); 
  LCD_ShowString(15,165,200,16,16,"btemp:");  
  LCD_ShowString(15,185,230,16,16,"hrate:");
  LCD_ShowString(15,205,200,16,16,"spo2:");
//	LCD_ShowString(15,225,230,16,16,"up-monitor:");		
