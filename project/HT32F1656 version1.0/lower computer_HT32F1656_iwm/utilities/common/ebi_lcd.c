...
void screen_init_background(void)
{
  ...
  POINT_COLOR=DARKBLUE;
	LCD_ShowString(12,35,200,16,16,"mumber:Sch/Lr/Pzx/Pqc.");
	POINT_COLOR=BLUE;
...
//	LCD_DrawLine(7, 175, 110, 175);//横
//	LCD_DrawLine(110, 65, 110, 175);//竖
//	LCD_Fill(115,90,135,110,RED);
//	LCD_ShowString(140,90,200,16,16,"busy");
//	LCD_Fill(115,120,135,140,BLUE);
//	LCD_ShowString(140,120,200,16,16,"free");
